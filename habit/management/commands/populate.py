...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if not User.objects.exists():
            ...
            user = User.objects.create_user(username="testuser", password="1234", email="test@example.com")
        else:
        ...
        actions = ["Утренняя зарядка", "Планирование задач", "Чтение книги", "Медитация", "Пробежка", "Йога"]
        rewards = ["Хорошее настроение", "Эффективный день", "Отдых", "Прогресс", "Бонус от босса"]
