...
class UserAPITestCase(APITestCase):
    def setUp(self):
        ...
        self.superuser = CustomUser.objects.create_superuser(
            email="super@example.com", username="superuser", password="superpassword123"
        )
    ...
    def test_user_update(self):
        ...
        data = {"phone_number": "1112223333", "city": "UpdatedCity"}
    ...
    def test_update_other_user(self):
        ...
        data = {"phone_number": "1234567890", "city": "NewCity"}
        response = self.client.patch(url, data, format="json")
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
    ...
    def test_superuser_update_other_user(self):
        ...
        url = reverse("users:user-update", kwargs={"pk": self.user.pk})
        data = {"phone_number": "9998887777", "city": "SuperCity"}
        response = self.client.patch(url, data, format="json")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.user.refresh_from_db()
    ...
    def test_update_other_fields(self):
        ...
        data = {"email": new_email, "phone_number": new_phone}
    ...
    def test_unauthorized_update(self):
        ...
        other_user = CustomUser.objects.create_user(
            email="other@example.com", username="otheruser", password="otherpassword123"
        )
